========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : mbug_2810_gui
========================================================================


Diese mbug_2810_gui-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre mbug_2810_gui-Anwendung bilden.
...
mbug_2810_gui.h
	...
	Anwendungsklasse CMbug_2810_guiApp.
...
res\mbug_2810_gui.ico
    Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
	Symbol wird durch die Haupt-Ressourcendatei mbug_2810_gui.rc eingebunden.

res\mbug_2810_gui.rc2
...
mbug_2810_guiDlg.h, mbug_2810_guiDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CMbug_2810_guiDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in mbug_2810_gui.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	mbug_2810_gui.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
