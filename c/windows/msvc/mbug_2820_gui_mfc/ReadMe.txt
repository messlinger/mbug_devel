========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : mbug_2820_gui
========================================================================


Diese mbug_2820_gui-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre mbug_2820_gui-Anwendung bilden.
...
mbug_2820_gui.h
	...
	Anwendungsklasse CMbug_2820_guiApp.
...
res\mbug_2820_gui.ico
    Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
	Symbol wird durch die Haupt-Ressourcendatei mbug_2820_gui.rc eingebunden.

res\mbug_2820_gui.rc2
...
mbug_2820_guiDlg.h, mbug_2820_guiDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CMbug_2820_guiDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in mbug_2820_gui.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	mbug_2820_gui.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
