...
"                 Always specify an even number of intervals. Maximum number   \n"
"                 of intervals is 254.  The maximum interval time is 600 sec   \n"
"                 for < 128 intervals, 4 sec for >=128 intervals.              \n"
"                 Best possible time resolution is 1 micosecond, but           \n"
"                 increases with the maximum of the sequence time interval.    \n"
"                                                                              \n"
